...
```H3.DataModel.PropertySchema``` 的具体说明请查看：[H3.DataModel.PropertySchema](/docs/cs-instance?id=h3datamodelpropertyschema)
...
其他附件复制方法请参考此文档：[附件图片复制](/docs/bo-set-get?id=附件图片)
